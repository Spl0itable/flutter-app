...
class NymIcons {
  ...
  /// return. A share glyph read as "send this somewhere", which is not what
  /// the button does: it measures the round trip and the hop count to a peer.
  static const String radar =
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" '
      'stroke-linecap="round" stroke-linejoin="round">'
      '<circle cx="12" cy="12" r="9"/>'
      '<circle cx="12" cy="12" r="4.75"/>'
      '<path d="M12 12 L18.36 5.64"/>'
  ...
  /// Message threads — the chat-bubble-with-lines glyph used by the thread
  /// hover button, the "N replies" row, and the thread panel (filled).
  static const String thread = '<svg viewBox="0 0 20 20">'
      '<path fill="currentColor" fill-rule="evenodd" d="M10 3a7 7 0 1 0 3.394 '
      '13.124.75.75 0 0 1 .542-.074l2.794.68-.68-2.794a.75.75 0 0 1 '
      '.073-.542A7 7 0 0 0 10 3m-8.5 7a8.5 8.5 0 1 1 16.075 3.859l.904 '
      '3.714a.75.75 0 0 1-.906.906l-3.714-.904A8.5 8.5 0 0 1 1.5 10M6 '
      '8.25a.75.75 0 0 1 .75-.75h6.5a.75.75 0 0 1 0 1.5h-6.5A.75.75 0 0 1 6 '
      '8.25M6.75 11a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5z" '
  ...
  /// Sidebar `#nymchat` menu — a house, for the Default Landing Channel entry.
  static const String sidebarHome =
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" '
      'stroke-linecap="round" stroke-linejoin="round">'
